...
static inline void set_baud_rate(USART_TypeDef *uart_channel, const uart_config_t *config, bool is_lpuart)
{
...
{
    return (ring_buffer_read(&rx_buffers[instance], data) == STATUS_OK) ? STATUS_OK : STATUS_ERR_EMPTY;
}
